...
function calculate() {
  ...
  fetch(
    `https://v6.exchangerate-api.com/v6/90fcb603c8ce2d4ba4d42a03/latest/${moneda_one}`
  )
    .then((res) => res.json())
    .then((data) => {
...
document.querySelector("#botonReservar").addEventListener("click", reservarDestino);
function reservarDestino() {
    ...
    x.innerHTML=`<div id="reserva">
        <form action="/store" method="post" id="registro" action="">
            ...
            <input type="text" size="24" name="firstname" id="firstname" placeholder="Ingrese su nombre aquí..." required>
            </label>
            <label for="lastname">&nbsp;&nbsp;&nbsp;Apellido:
                <input type="text" size="20" name="lastname" id="lastname" placeholder="Ingrese su apellido aquí..." required>
            </label>                                           
            <label for="city">Destino:
                <input type="text" size="32" name="city" id="city" placeholder="Ingrese la ciudad de destino">
            </label>
            <label for="night">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Noches:
                <input type="number" size="10" name="night" id="night">
            </label>
            <label for="email">Correo electrónico:
                <input type="email" name="email" id="email" size="24" placeholder="Ingrese su correo electrónico" required>
            </label>
            <label for="phone">&nbsp;&nbsp;&nbsp;Teléfono:
                <input type="tel" size="15" name="phone" id="phone" maxlength="13" placeholder="Ingrese su teléfono">
            </label>
            ...
            <label for="price">Precio total:
                <input name="price" id="price" type="number" value="=esp.value">
            </label>                      
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="confirmarReserva" type="submit" value="CONFIRMAR RESERVA">
        </form>
    </div>`
